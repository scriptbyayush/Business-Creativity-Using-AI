    ...
    >   
      ...
      >
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src={bizgenius} width={190} height={40} alt="bizgenius" />
        </a>
        ...
        >
          ...
          >
            {navigation.map((item) => (
              ...
              ${
                item.url === pathname // ✅ Now works correctly
                  ? "z-2 lg:text-n-1"
                  : "lg:text-n-1/50"
...
<Button className="hidden lg:flex" href="index copy.html">
  Sign in
</Button>
