...
import ShufflerComponent from "./Shuffler";
      ...
      mb-[4rem] md:mb-20 lg:mb-[6rem]"
        >
          <h1 className="h1 mb-6">
            Explore AI-powered Market Insights for Smarter Decisions with{" "}
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            Unleash the power of AI within bizgenius.Upgrade your productivity
            with bizgenius, the open AI Campain Builder app. 
          </p>
